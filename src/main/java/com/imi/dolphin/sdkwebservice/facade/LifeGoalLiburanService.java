 ...
 */
@Service
public class LifeGoalLiburanService {
    ...
    public ExtensionResult lifeGoalLiburan_validasiJudulLifeGoal(ExtensionRequest extensionRequest) {
        ...
        clearEntities = validationMethod.validasiJudulLifeGoalLiburan(judulLifeGoal);
        ...
        if (clearEntities.get("judul_life_goal").equals("")) {
            output.put(OUTPUT, dialogUtil.CreateBubble("lifeGoalLiburan_validasiJudulLifeGoal", 1, null));
        } else {
